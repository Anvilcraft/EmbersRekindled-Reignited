...
public class EmbersLang extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add("itemGroup." + Embers.MODID, "Embers Re-Ignited");
		...
		addBlock(RegistryManager.CAMINITE_BUTTON, "Caminite Button");
		...
		addBlock(RegistryManager.CAMINITE_GAUGE, "Caminite Gauge");
		addBlock(RegistryManager.CAMINITE_GAUGE_EDGE, "Caminite Gauge");
		...
		addUpgradeDesc(RegistryManager.CATALYTIC_PLUG_ITEM, "Increases machine speed, or boosts Ember Kinetic Generator speed and stress output, at the cost of gaseous fuel.");
