...
public class EmbersDamageTypes {
	...
	public static final ResourceKey<DamageType> EMBER_KEY = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(Embers.MODID, "ember"));
