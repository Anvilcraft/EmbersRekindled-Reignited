...
public class FilterSieve implements IFilter {
	public static final ResourceLocation RESOURCE_LOCATION = ResourceLocation.fromNamespaceAndPath(Embers.MODID, "sieve");
	...
	public CompoundTag writeToNBT(CompoundTag tag) {
		...
		tag.put("stack1",ItemData.save(stack1));
		tag.put("stack2",ItemData.save(stack2));
	...
	public void readFromNBT(CompoundTag tag) {
		stack1 = ItemData.parse(tag.getCompound("stack1"));
		stack2 = ItemData.parse(tag.getCompound("stack2"));
