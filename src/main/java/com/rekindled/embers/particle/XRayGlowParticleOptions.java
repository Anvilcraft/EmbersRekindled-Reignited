...
public class XRayGlowParticleOptions implements LegacyParticleOptions {
	...
	public static final LegacyParticleDeserializer<XRayGlowParticleOptions> DESERIALIZER = new LegacyParticleDeserializer<XRayGlowParticleOptions>() {
