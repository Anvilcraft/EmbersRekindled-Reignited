...
public class TyrfingParticleOptions implements LegacyParticleOptions {
	...
	public static final LegacyParticleDeserializer<TyrfingParticleOptions> DESERIALIZER = new LegacyParticleDeserializer<TyrfingParticleOptions>() {
