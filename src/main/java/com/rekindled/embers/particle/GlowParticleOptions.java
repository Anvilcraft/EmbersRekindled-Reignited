...
public class GlowParticleOptions implements LegacyParticleOptions {
	...
	public static final LegacyParticleDeserializer<GlowParticleOptions> DESERIALIZER = new LegacyParticleDeserializer<GlowParticleOptions>() {
		...
		public GlowParticleOptions fromNetwork(ParticleType<GlowParticleOptions> p_123692_, FriendlyByteBuf p_123693_) {
			return new GlowParticleOptions(p_123693_.readResourceLocation(), GlowParticleOptions.readVector3f(p_123693_), GlowParticleOptions.readVec3(p_123693_), p_123693_.readFloat(), p_123693_.readInt());
		}
	};
