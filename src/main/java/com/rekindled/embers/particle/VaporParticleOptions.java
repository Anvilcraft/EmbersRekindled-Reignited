...
public class VaporParticleOptions implements LegacyParticleOptions {
	...
	public static final LegacyParticleDeserializer<VaporParticleOptions> DESERIALIZER = new LegacyParticleDeserializer<VaporParticleOptions>() {
