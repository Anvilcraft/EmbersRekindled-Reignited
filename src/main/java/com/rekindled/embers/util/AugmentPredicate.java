...
public class AugmentPredicate extends ItemPredicate {
	...
	public static final ResourceLocation ID = ResourceLocation.fromNamespaceAndPath(Embers.MODID, "augment");
	...
	public static AugmentPredicate deserialize(JsonObject json) {
		IAugment augment = AugmentUtil.getAugment(ResourceLocation.fromNamespaceAndPath(GsonHelper.getAsString(json, "augment")));
		int level = 1;
		if (json.has("level"))
