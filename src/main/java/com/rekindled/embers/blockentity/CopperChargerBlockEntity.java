...
public class CopperChargerBlockEntity extends BlockEntity implements ISoundController, IExtraDialInformation, IExtraCapabilityInformation, IUpgradeable {
	...
	public ItemStackHandler inventory = new ItemStackHandler(1) {
		...
		public boolean isItemValid(int slot, @NotNull ItemStack stack) {
			return com.rekindled.embers.util.CapabilityCompat.getCapability(stack, EmbersCapabilities.EMBER_CAPABILITY, null).isPresent();
		}
	...
	public static void serverTick(Level level, BlockPos pos, BlockState state, CopperChargerBlockEntity blockEntity) {
		...
		IEmberCapability itemCapability = com.rekindled.embers.util.CapabilityCompat.getCapability(stack, EmbersCapabilities.EMBER_CAPABILITY, null).orElse(null);
