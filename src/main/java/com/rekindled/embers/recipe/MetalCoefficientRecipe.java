...
public class MetalCoefficientRecipe implements IMetalCoefficientRecipe {
	...
	public static class Serializer extends LegacyRecipeSerializer<MetalCoefficientRecipe> {

		@Override
		public MetalCoefficientRecipe fromJson(ResourceLocation recipeId, JsonObject json) {
			ResourceLocation blockTag = ResourceLocation.parse(json.get("block_tag").getAsString());
